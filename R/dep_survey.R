#' @title dep_survey
#' @description dep survey data inputs
#' @format A data frame with 1225 rows and 49 variables:
#' \describe{
...
#'   \item{\code{qz}}{double COLUMN_DESCRIPTION}
...
#'   \item{\code{q29n}}{double COLUMN_DESCRIPTION}
...
#'   \item{\code{Q41_oth}}{character COLUMN_DESCRIPTION}
...
#'   \item{\code{weights}}{double COLUMN_DESCRIPTION}
#'}
#' @details Li et al 2024
"dep_survey"
